...
class LanguageViewModel @Inject constructor(
    ...
    init {
        val isButtonClicked = sharedPreferences.getBoolean(IS_FIRST_LAUNCH_BUTTON_CLICKED, false)
    ...
    fun isButtonClickedFunction(language: String) {
        sharedPreferences.edit().putBoolean(IS_FIRST_LAUNCH_BUTTON_CLICKED, true).apply()
